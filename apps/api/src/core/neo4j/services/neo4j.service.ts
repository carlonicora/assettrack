...
export class Neo4jService implements OnModuleInit, OnModuleDestroy {
  ...
  constructor(
    ...
    this._database = this.config.get<ConfigNeo4jInterface>("neo4j").database;
    this.driver = driver(
      this.config.get<ConfigNeo4jInterface>("neo4j").uri,
      auth.basic(
        this.config.get<ConfigNeo4jInterface>("neo4j").username,
        this.config.get<ConfigNeo4jInterface>("neo4j").password,
      ),
      {
  ...
  getConfig(params: { indexName: string; nodeLabel: string; textNodeProperty: string }): any {
    if (!this._database)
      return {
        url: this.config.get<ConfigNeo4jInterface>("neo4j").uri,
        username: this.config.get<ConfigNeo4jInterface>("neo4j").username,
        password: this.config.get<ConfigNeo4jInterface>("neo4j").password,
        database: this.config.get<ConfigNeo4jInterface>("neo4j").database,
